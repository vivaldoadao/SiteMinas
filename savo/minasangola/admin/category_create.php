    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12" style="margin-left: 10px;">
                <a href="category.php" onclick="inserir()" style="margin-bottom: 10px;" type="button" class="btn btn-success">
                    Gestã de Categorias
                </a>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Criar  <small>Categoria</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="category_create.php" method="post" >
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" name="add-category" class="btn btn-primary">Criar</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
