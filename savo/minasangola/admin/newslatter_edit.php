                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Editar Email</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Editar <small>Email</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
?>
                  ...
                  <div class="row">
                    ...
                    <input type="email" name="email" value="<?php  echo $email;  ?>" class="form-control" id="exampleInputEmail1" placeholder="Inserir Nome">
                  </div>
                    </div>
                ...
                <div class="card-footer">
                  <button type="submit" name="update-newslatter" class="btn btn-primary">Criar</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
