...
<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="sidebar sidebar-right">
						<div class="widget">
							...
							<li><a href="https://www.linkedin.com/company/minas-de-angola" target="blank"><i class="fa fa-linkedin"></i></a></li>
								<li><a href="https://www.facebook.com/Portal-Minas-de-Angola-105063565350342" target="blank" ><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://www.instagram.com/portal_minas_de_angola/" target="blank" ><i class="fa fa-instagram"></i></a></li>
						...
						<?php   foreach ($sideBarAdvertises as $sideBarAdvertise): ?>
							...
							<a href="\<?php echo $topadvertise['link']?>" target="blank"><img class="banner img-responsive" src="admin/assets/img/advertise/<?php echo $sideBarAdvertise['image']?>" alt="" /></a>
							<?php   endforeach;?>
						</div><!-- Sidebar Ad end -->
