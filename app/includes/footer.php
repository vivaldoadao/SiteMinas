									...
									<div class="post-block-style post-float clearfix">
										...
										<div class="post-content">
								 			<h2 class="post-title title-small">
								 				...
								 				<a href="single.php?id=<?php  echo $post['id'];   ?>"><?php  echo html_entity_decode(substr($post['title'],0, 40). '...');   ?></a>
								 			</h2>
								 			<div class="post-meta">
						...
						<div class="footer-info-content">
							...
							<ul class="unstyled footer-social">
								<li>
									...
									<a title="Facebook" href="https://www.facebook.com/Portal-Minas-de-Angola-105063565350342" target="blank">
										<span class="social-icon"><i class="fa fa-facebook"></i></span>
									</a>
								
								
									<a title="Linkdin" href="https://www.linkedin.com/company/minas-de-angola" target="blank">
										<span class="social-icon"><i class="fa fa-linkedin"></i></span>
									</a>
							
									<a title="Skype" href="https://www.instagram.com/portal_minas_de_angola/" target="blank">
