			...
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						...
						<div class="post-title-area">
							...
							<?php  echo $p['title'];  ?>
				 			...
				 			<div class="post-meta">
								...
								<span class="post-comment"><i class="">Fonte:  <?php echo $p['font']?> -</i>
						...
						<div class="post-content-area">
							...
							<div class="share-items clearfix">
   							<ul class="post-social-icons unstyled">
   								<li class="facebook">
   									<a href="https://www.facebook.com/Portal-Minas-de-Angola-105063565350342" target="blank">
   									<i class="fa fa-facebook"></i> <span class="ts-social-title">Facebook</span></a>
   								</li>
   								<li class="twitter">
   									<a href="https://www.linkedin.com/company/minas-de-angola" target="blank">
   									<i class="fa fa-linkedin"></i> <span class="ts-social-title">Linkedin</span></a>
   								</li>
   								<li class="gplus">
   									<a href="https://www.instagram.com/portal_minas_de_angola/" taget="blank">
   									<i class="fa fa-instagram"></i> <span class="ts-social-title">Youtube</span></a>
   								</li>
					...
					<div class="author-box">
                        ...
                        <a href="https://www.linkedin.com/company/minas-de-angola" target="blank"><i class="fa fa-linkedin"></i></a>
                        <a href="https://www.facebook.com/Portal-Minas-de-Angola-105063565350342" target="blank"><i class="fa fa-facebook"></i></a>
                        <a href="https://www.instagram.com/portal_minas_de_angola/" taget="blank"><i class="fa fa-instagram"></i></a>
	...
	?>	
					...
					<div class="comments-form">
						...
						<form action="#" method="post">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<textarea class="form-control required-field" name="description"  placeholder="Escreva o seu comentário" rows="10" required></textarea>
									</div>
								</div><!-- Col end -->

								<div class="col-md-12">
									<div class="form-group">
										<input class="form-control" name="name" id="name" placeholder="Nome" type="text" required>
									</div>
								</div><!-- Col end -->
							...
							<div class="clearfix">
								<button class="comments-btn btn btn-primary" name="btnComment" type="submit">Fazer Comentário</button> 
							</div>
						</form><!-- Form end -->
