...
$entrevistas = getPostsByCategoryENTREVISTAS();
			...
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					...
					<div class="block category-listing category-style2">
						...
						<?php   foreach ($entrevistas as $post): ?>
...
if ($page>1) {
	# code...
	$pageLink.="<li ><a class='page-link'href=entrevistas.php?page=1>First</a></li>";
	$pageLink.="<li ><a class='page-link'href='entrevistas.php?page=".($page-1)."'>«</a></li>";
}
...
for ($i=1; $i <=$totalPages ; $i++) { 
	...
	$pageLink.="<li ><a class='page-link'href='entrevistas.php?page=".$i."'>".$i."</a></li>";
}
...
if ($page<=$totalPages) {
	...
	$pageLink.="<li ><a class='page-link'href='entrevistas.php?page=".($page+1)."'>»</a></li>";
	$pageLink.="<li ><a class='page-link'href='entrevistas.php?page=".$totalPages."'>Last</a></li>";
