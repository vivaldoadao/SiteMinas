                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Criar Usuaário</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Criar  <small>Usuário</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="user_create.php" method="post" id="quickForm2" enctype="multipart/form-data">
                <div class="card-body">
                <?php   
                  ...
                  <div class="row">
                        <div class="col-md-1">
                          <div class="card-footer">
                            <button type="submit" name="create-admin" class="btn btn-primary">Criar</button>
                          </div>
                        </div>
                        <div class="col-md-11">
                          <div class="card-footer">
