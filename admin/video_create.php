        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">VÍDEO</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Cadastrar <small>Vídeo</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="video_create.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="row">
                        <div class="col-md-1">
                          <div class="card-footer">
                            <button type="submit" name="add-video" class="btn btn-primary">Criar</button>
                          </div>
                        </div>
                        <div class="col-md-11">
                          <div class="card-footer">
