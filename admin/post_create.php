          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Criar  <small>Notícia</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="post_create.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="row">
                          ...
                          <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Titulo</label>
                                    <input type="text" id="title" name="title"  value="<?php echo $title; ?>" class="form-control" placeholder="Titulo da Notícia">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                              ...
                              <input type="text" id="font" name="font"  value="<?php echo $font; ?>" class="form-control" placeholder="Fonte da Notícia">
                          </div>
                  </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                            <textarea  type="text" class="form-control" id="editor"  name="body" placeholder="Descrição da notícia" ><?php echo $body; ?></textarea>
                            </div>
                        </div>
                ...
                <div class="row">
                        <div class="col-md-1">
                          <div class="card-footer">
                            <button type="submit" name="add-post" class="btn btn-primary">Criar</button>
                          </div>
                        </div>
                        <div class="col-md-11">
                          <div class="card-footer">
                          <a href="posts.php"   type="button" class="btn btn-danger">Cancelar</button></a>
