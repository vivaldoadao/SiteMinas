                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Criar Publicidade</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Criar  <small>Publicidade</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Link</label>
                                    <input type="text" id="link" name="link"  value="<?php echo $link; ?>" class="form-control" placeholder="">
                                </div>
                            </div>
                ...
                <div class="row">
                        <div class="col-md-1">
                          <div class="card-footer">
                            <button type="submit" name="add-advertise" class="btn btn-primary">Criar</button>
                          </div>
                        </div>
                        <div class="col-md-11">
                          <div class="card-footer">
