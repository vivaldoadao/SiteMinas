                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../img/parceiros/<?php echo $res2[$i]['imagem']?>" alt="..." class="img-thumbnail" style="width: 100px;"></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><span id="tituloModal">Inserir Parceiro</span></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" id="form-inserir-parceiro" method="POST">
...
<div class="modal fade" id="modal-lg-editar">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="form-parceiro-editar" method="POST">
                <div class="modal-body">
                    <div class="card-body">
...
<div class="modal fade" id="modal-lg-excluir">
    <div class="modal-dialog">
        <div class="modal-content bg-danger">
            ...
            <form class="form-horizontal" id="form-parceiro-excluir" method="POST">
                <div class="modal-body">
                    <div class="card-body">
...
<script>
    ...
    function editar(id, titulo, descricao, imagem) {
        ...
        $('#tituloModal').text('Editar Parceiro');
    ...
    function inserir() {
        $('#mensagem-excluir').text('');
        $('#tituloModal').text('Inserir  Parceiro');
    ...
    function excluir(id) {
        $('#id-excluir').val(id);
        $('#tituloModal').text('Excluir  Parceiro');
