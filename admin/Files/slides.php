                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td><img src="../img/slides/<?php echo $res2[$i]['imagem']?>" alt="..." class="img-thumbnail" style="width: 100px;"></td>
      
                                            <td></td>
                                            <td>
                                                <div class="btn-group btn-group-sm-md-12 center">
                                                    <a href="#" onclick="editar('<?php echo $res2[$i]['id']      ?>','<?php echo $res2[$i]['titulo']      ?>' ,'<?php echo $res2[$i]['subtitulo']      ?>' , '<?php echo $res2[$i]['created_on']      ?>' , '<?php echo $res2[$i]['imagem']      ?>')" class="btn btn-info" title="Editar Registro"><i class="fas fa-edit"></i></a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><span id="tituloModal">Inserir Slide</span></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" id="form-inserir-slide" method="POST">
...
<div class="modal fade" id="modal-lg-editar">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><span id="tituloModal">Editar Slide</span></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" id="form-slide-editar" method="POST">
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Subtitulo</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="subtitulo-editar" name="subtitulo-editar" placeholder="Subtitulo" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputFile">Imagem</label>
...
<div class="modal fade" id="modal-lg-excluir">
    <div class="modal-dialog">
        <div class="modal-content bg-danger">
            ...
            <form class="form-horizontal" id="form-slide-excluir" method="POST">
                <div class="modal-body">
                    <div class="card-body">
...
<script>
    ...
    function editar(id, titulo, subtitulo, imagem) {
        $('#mensagem-excluir').text('');
        $('#id-editar').val(id);
        $('#titulo-editar').val(titulo);
        $('#subtitulo-editar').val(subtitulo);
        $('#imagem-editar').val(imagem);
        $('#tituloModal').text('Editar Slide');
    ...
    function inserir() {
        $('#mensagem-excluir').text('');
        $('#tituloModal').text('Inserir  Slide');
