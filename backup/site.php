		...
		<div class="container">
			<div class="row">
				...
				<?php   foreach ($centroAdvertises as $centroAdvertise): ?>
					<img class="img-responsive" src="admin/assets/img/advertise/<?php echo $centroAdvertise['image']?>" alt="" />
		...
		<div class="container">
			<div class="row">
				...
				<?php   foreach ($downAdvertises as $downAdvertise): ?>
					<img class="img-responsive" src="admin/assets/img/advertise/<?php echo $downAdvertise['image']?>" alt="" />
					<?php   endforeach;?>
				</div><!-- Col end -->
			</div><!-- Row end -->
		</div><!-- Container end -->
