              ...
              <form role="post_create.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Titulo</label>
                                    <input type="text" id="title" name="title"  value="<?php echo $title; ?>" class="form-control" placeholder="Enter ...">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <?php  if(empty($published)): ?>
                              ...
                              <input type="checkbox" name="published"  class="custom-control-input"  checked>
                              <label class="custom-control-label" for="exampleCheck1">Publicar</label>
                        ...
                        <input type="checkbox" name="emphasis" class="form-check-input" >
                       <label class="form-check-label"for="exampleCheck1">Em Destaque</label>
                       <?php  else: ?>

                        <input type="checkbox" name="emphasis" class="form-check-input"  checked>
                       <label class="form-check-label"for="exampleCheck1">Em Destaque</label>
